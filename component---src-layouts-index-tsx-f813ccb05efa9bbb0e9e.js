...
/***/ (function(module, exports, __webpack_require__) {
	...
	const TemplateWrapper = ({ children }) => React.createElement(styles_1.MuiThemeProvider, { theme: theme, sheetsManager: new Map() }, React.createElement("div", null, React.createElement(react_helmet_1.Helmet, { title: "Hallingdata", meta: [{ name: "description", content: "Sample" }, { name: "keywords", content: "sample, something" }] }), React.createElement(NavBar_1.NavBar, null), children(), React.createElement(Footer_1.Footer, null)));
...
//# sourceMappingURL=component---src-layouts-index-tsx-f813ccb05efa9bbb0e9e.js.map