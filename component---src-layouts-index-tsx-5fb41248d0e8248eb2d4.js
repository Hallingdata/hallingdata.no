...
/***/ (function(module, exports, __webpack_require__) {
	...
	const TemplateWrapper = ({ children }) => React.createElement(styles_1.MuiThemeProvider, { theme: theme }, React.createElement("div", null, React.createElement(react_helmet_1.Helmet, { title: "Hallingdata", meta: [{ name: "description", content: "Sample" }, { name: "keywords", content: "sample, something" }] }), React.createElement(NavBar_1.NavBar, null), React.createElement(Footer_1.Footer, null)));
...
//# sourceMappingURL=component---src-layouts-index-tsx-5fb41248d0e8248eb2d4.js.map