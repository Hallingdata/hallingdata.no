...
/***/ (function(module, exports, __webpack_require__) {
	...
	}, pages)), React.createElement(material_ui_1.Hidden, { mdUp: true }, React.createElement(NavDrawer_1.NavDrawer, { links: pages }))));
	const styles = theme => ({
	    navButton: {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	const templateWrapper = ({ children, classes }) => React.createElement(styles_1.MuiThemeProvider, { theme: theme }, React.createElement("div", null, React.createElement(react_helmet_1.Helmet, { title: "Hallingdata", meta: [{ name: "description", content: "Sample" }, { name: "keywords", content: "sample, something" }] }), React.createElement(NavBar_1.NavBar, null), React.createElement("main", { className: classes.content }, children()), React.createElement(Footer_1.Footer, null)));
...
//# sourceMappingURL=component---src-layouts-index-tsx-b7544d7a3830ac0ed7e4.js.map